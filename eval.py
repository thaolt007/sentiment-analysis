...
x_raw= ["sản phẩm này tệ, rất thất vọng",
        "máy chán quá, đúng là phí tiền",
        "lazada làm việc càng ngày càng chán",
        "camera chả ra gì, chụp xấu hoắc",
        "máy khá ốn đấy chứ mọi người",
        "máy hoàn thiện cũng tốt"
        ]
